...
export default function WhatWeDo() {
  return (
    <section
      className=" bg-pink-800 text-light-pink pt-10 pb-20 md:px-14 px-2 sm:px-5 rounded-3xl -mt-[50px] shadow-lg "
      id="what-we-do"
    >
      <div className="gap-16 items-center py-8 px-4 mx-auto max-w-screen-2xl lg:grid lg:grid-cols-2 lg:py-14 lg:px-5 2xl:px-20">
        <div>
        ...
        <ServicesCard
          ...
          icon={
            <svg
              ...
              strokeWidth="1.5"
              stroke="currentColor"
              className="size-[200px] mx-auto my-5"
            >
              <path
                strokeLinecap="round"
                strokeLinejoin="round"
