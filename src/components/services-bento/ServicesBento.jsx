...
export default function ServicesBento() {
  return (
    <section className="w-full py-10 md:px-10 px-5 flex flex-end mt-[-80px]">
      {/* LEFT SIDE GRID */}
      <div class="grid grid-cols-1 gap-y-[20px] w-1/3 overflow-hidden justify-end items-center border-2">
        <div class="flex h-[400px]  self-end">
          <Image
            src={bentoImage}
      ...
      <div class="grid grid-cols-2 gap-[20px] w-2/3 px-4 items-end overflow-hidden">
        <div class="flex items-center justify-center h-[200px] col-span-1 self-end">
          hey
        </div>
