...
export default function Hero() {
  return (
    <section className="hero bg-pink-900 text-pink-200 md:px-10 px-5 py-10 flex">
      ...
      {/* add card bellow to its own component? in case it needs to be reused  */}

      <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 ">
        <div class="mr-auto place-self-center lg:col-span-7">
          <h2 class="max-w-2xl mb-4 mt-20 text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl border-0">
