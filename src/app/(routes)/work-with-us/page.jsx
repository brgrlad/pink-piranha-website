...
export default function WorkWithUs() {
  return (
    <section class="grid grid-cols-1 lg:grid-cols-3 p-5 md:p-10">
      <div className="formWrapper w-[100%] col-span-2 flex flex-col order-2 lg:order-1">
        <h2 class="text-4xl md:text-6xl py-5">Work with us!</h2>
        <form class="mb-20">
          <div class="mb-5">
            <label
              for="base-input"
          ...
          <button class="bg-pink-500 hover:bg-pink-700 text-white font-bold py-2 px-4 rounded-full absolute my-5">
            Send Message
          </button>
        </form>
      </div>
